...
<div class="auth-page">
    ...
    <section class="banner">
        <div class="banner-content">
            ...
            <p>
                أدخل رمز التحقق المرسل إلى بريدك الإلكتروني، ثم أنشئ كلمة مرور جديدة لحساب بوابة الموظف.
            </p>
    ...
    <section class="form-side">
        <div class="auth-card">
            ...
            <p class="subtitle">أدخل الرمز المرسل إلى بريدك الإلكتروني ثم أنشئ كلمة مرور جديدة</p>
            ...
            <form method="POST" action="{{ route('employee-portal.reset-password.store') }}">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="field-note">أدخل الرمز المكوّن من 6 أرقام المرسل إلى بريدك الإلكتروني.</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-box">
                            ...
                            <button type="button" class="toggle-password" onclick="togglePassword('passwordConfirmation')">
                                <i class="fas fa-eye"></i>
                            </button>
                        </div>
                    </div>
