...
<head>
    ...
    <title>نسيت كلمة المرور | ENG-SHADI HR</title>
...
<div class="auth-page">
    ...
    <section class="banner">
        <div class="banner-content">
            ...
            <p>
                أدخل رقم الإقامة والبريد الإلكتروني المسجل، وسيتم إرسال رمز إعادة التعيين إلى بريدك.
            </p>
            ...
            <div class="features">
                ...
                <div class="feature">
                    ...
                    مطابقة البريد الإلكتروني المسجل
                </div>
    ...
    <section class="form-side">
        <div class="auth-card">
            ...
            <p class="subtitle">أدخل رقم الإقامة والبريد الإلكتروني لإرسال رمز إعادة التعيين</p>
            ...
            <form method="POST" action="{{ route('employee-portal.forgot-password.send') }}">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="field-note">أدخل رقم الإقامة بالأرقام فقط.</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field-note">يجب أن يطابق البريد الإلكتروني المسجل في ملف الموظف.</div>
                    </div>
            ...
            <div class="secondary-box">
                تذكرت كلمة المرور؟
                <a href="{{ route('unified-login', ['account' => 'employee']) }}">العودة لتسجيل الدخول</a>
            </div>
