...
<head>
    ...
    <style>
        *{box-sizing:border-box}
        ...
        th,td{border:1px solid #d1d5db;padding:7px;text-align:center;font-size:10px}
        th{background:#ede9fe;color:#4c3b91;font-weight:900}
        .amount{direction:ltr;font-weight:900}
        ...
        @media print{.no-print{display:none}@page{size:A4 landscape;margin:10mm}body{margin:0}}
    </style>
</head>
<body>
<div class="no-print">
...
<div class="header">
    ...
    <p>المسير: {{ $payrollPeriod->period_number }} | الشهر: {{ $payrollPeriod->month }} | تاريخ الطباعة: {{ now()->format('Y-m-d H:i') }}</p>
</div>
